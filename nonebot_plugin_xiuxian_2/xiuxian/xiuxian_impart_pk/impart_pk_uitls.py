...
msg_pass = {
    0: ["向对手挥出了一掌\r", "向对手迸发出一波剑气\r", "向对手发动了法宝\r"],
    1: ["受到了对手的攻击，防御被攻破了\r", "受到了对手的攻击，防御被攻破了\r", "受到了对手的攻击，防御被攻破了\r"],
    2: ["整顿了一下剩下的防具，重整了姿势\r", "整顿了一下剩下的法宝，重整了姿势\r", "整顿了一下真气，重整了姿势\r"],
    3: ["感受到了天地间的动荡，貌似有奇遇将要出现\r", "前方空间发生了变化，是福是祸，犹未可知\r"],
    4: ["奇遇的降临让你获得了荒天帝的精血传承，一股力量涌入，头脑中突然符文密布，随机迸发了出来，环绕着你的身体。"
        "随机你只是在心中默念了一下符文，随即乾坤颠覆，日月无光，山河颓势尽显，虚神界的境界压制瞬间就被你打破了，"
        "随后你筋疲力尽意识陷入了模糊\r", "奇遇的降临让你得到了一片柳枝，一股力量涌入，头脑中突然符文密布，"
                            "随机迸发了出来，环绕者你的身体。随机你只是在心中默念了一下符文，随即乾坤颠覆，日月无光，山河颓势尽显，"
                            "虚神界的境界压制瞬间就被你打破了，随后你筋疲力尽意识陷入了模糊\r"]
}
msg_died = {
    0: ["向对手挥出了一掌，结果对手一个接化发，败了\r", "向对手迸发出一波剑气，结果对手一个接化发，败了\r", "向对手发动了法宝，结果对手一个接化发，败了\r"],
    1: ["受到了对手的攻击，防具碎了，没有招架住，败了\r", "受到了对手的攻击，法宝碎了，没有招架住，败了\r", "受到了对手的攻击，肉身抗了下来，没有招架住，败了\r"],
    2: ["整顿了一下剩下的防具，结果力不从心，败了\r", "整顿了一下剩下的法宝，结果力不从心，败了\r", "整顿了一下真气，结果力不从心，败了\r"],
    3: ["感受到了天地间的动荡，貌似有奇遇将要出现，被卷入其中，败了\r", "前方空间发生了变化，被卷入其中，败了\r"],
    4: ["空间破碎，只听见一句“仙之巅，傲世间，有我安澜便有天。”你便被一只手掌抓入了空间裂隙中，败了\r", "奇遇降临，你本想向前去查看，但你却在看见裂隙中隐隐约约中"
                                                            "看见了那位的身影，你一股热血涌入心头，离开时虚神界，败了\r"],
    5: ["见空间不稳定，随机便用出了空间秘术，准备踏空间而去，但你进入空间裂隙之后，却发现裂隙在一点点破碎，仿佛将要不存在了一样，你顿时就好像明白了什么，但转眼间"
        "便消亡了，败了\r", "见空间不稳定，随机便用出了时间秘术，准备逆时间长河而去，但你进入时间裂隙之后，却发现裂隙在一点点破碎，仿佛将要不存在了一样，你顿时就"
                     "好像明白了什么，但转眼间便消亡了，败了\r"]
}
...
async def impart_pk_now_msg_to_bot(player_1_name, player_2_name):
    ...
    for x in range(len(bullet_list)):
        if x % 2 == 0:
            if bullet_list[x] == 0:
                msg += f"第{str(x + 1)}回合道友 {player_1_name}行动，出了一招！\r"

            elif bullet_list[x] == 1:
                msg += f"第{str(x + 1)}回合道友 {player_1_name}行动，出了一招，但失误了，败了！\r"
                win = 2
                break
            else:
                pass
            ...
            if bullet_list[x] == 0:
                msg += f"第{str(x + 1)}回合 {player_2_name}行动，出了一招！\r"

            elif bullet_list[x] == 1:
                msg += f"第{str(x + 1)}回合 {player_2_name}行动，出了一招，但失误了，败了！\r"
                win = 1
                break
            else:
                pass
