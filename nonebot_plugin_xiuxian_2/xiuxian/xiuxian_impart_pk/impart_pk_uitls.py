...
msg_died = {
    0: ["向对手挥出了一掌，结果对手一个接化发，败了\r", "向对手迸发出一波剑气，结果对手一个接化发，败了\r",
        "向对手发动了法宝，结果对手一个接化发，败了\r"],
    1: ["受到了对手的攻击，防具碎了，没有招架住，败了\r", "受到了对手的攻击，法宝碎了，没有招架住，败了\r",
        "受到了对手的攻击，肉身抗了下来，没有招架住，败了\r"],
    2: ["整顿了一下剩下的防具，结果力不从心，败了\r", "整顿了一下剩下的法宝，结果力不从心，败了\r",
        "整顿了一下真气，结果力不从心，败了\r"],
    3: ["感受到了天地间的动荡，貌似有奇遇将要出现，被卷入其中，败了\r", "前方空间发生了变化，被卷入其中，败了\r"],
    4: ["空间破碎，只听见一句“仙之巅，傲世间，有我安澜便有天。”你便被一只手掌抓入了空间裂隙中，败了\r",
