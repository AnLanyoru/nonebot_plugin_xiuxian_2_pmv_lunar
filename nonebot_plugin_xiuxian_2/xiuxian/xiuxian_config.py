...
def convert_rank(rank_name: str = '求道者'):
    ...
    ranks = [
        ...
        '无上仙帝·半步', '无上仙帝·初期', '无上仙帝·中期',
        '无上仙帝·后期', '无上仙帝·巅峰', '无上仙帝·大圆满',  # 194 - 199
        '无上仙尊·半步', '无上仙尊·初期', '无上仙尊·中期',
        '无上仙尊·后期', '无上仙尊·巅峰', '无上仙尊·大圆满',  # 200 - 205
...
class XiuConfig:
    def __init__(self):
        ...
        self.break_world_need = ["天人境圆满", "登仙境·九劫", "无上仙尊·大圆满"]  # 突破位面最低境界要求
        self.lunhui_min_level = "天人境圆满"  # 千世轮回最低境界
        self.twolun_min_level = "羽化境后期"  # 万世轮回最低境界
        self.threelun_min_level = "无上仙尊·大圆满"  # 无上轮回最低境界
