...
class LimitHandle:
    ...
    @staticmethod
    def change_offset_info_to_msg(offset_info):
        """
        格式化补偿数据为友好视图
        :param offset_info:
        :return:
    ...
    @staticmethod
    def update_user_offset(user_id, offset_id: int) -> bool | tuple[bool, str]:
        """
    ...
    @staticmethod
    def check_user_offset(user_id, offset_id: int) -> bool:
        """
    ...
    @staticmethod
    def update_user_log_data(user_id, msg_body: str) -> bool:
        """
        写入用户日志信息
        :param user_id: 用户ID
    ...
    @staticmethod
    def update_user_shop_log_data(user_id, msg_body: str) -> bool:
        """
        写入用户日志信息
        :param user_id: 用户ID
        :param msg_body: 需要写入的信息
    ...
    @staticmethod
    def get_user_shop_log_data(user_id):
        object_key = 'state'  # 可变参数，记得修改方法
        limit_dict, is_pass = limit_data.get_limit_by_user_id(user_id)
        state_dict = limit_dict[object_key]
        try:
    ...
    @staticmethod
    def update_user_donate_log_data(user_id, msg_body: str) -> bool:
        """
        写入用户周贡献信息
        :param user_id: 用户ID
        :param msg_body: 需要写入的信息
    ...
    @staticmethod
    def get_user_donate_log_data(user_id):
        object_key = 'state'  # 可变参数，记得修改方法
        limit_dict, is_pass = limit_data.get_limit_by_user_id(user_id)
        state_dict = limit_dict[object_key]
        try:
    ...
    @staticmethod
    def update_user_world_power_data(user_id, world_power) -> bool:
        """
        写入用户天地精华信息
        :param user_id: 用户ID
        :param world_power:
    ...
    @staticmethod
    def get_user_world_power_data(user_id):
        object_key = 'state'  # 可变参数，记得修改方法
        limit_dict, is_pass = limit_data.get_limit_by_user_id(user_id)
        state_dict = limit_dict[object_key]
        try:
    ...
    @staticmethod
    def get_user_rift_protect(user_id):
        limit_dict, is_pass = limit_data.get_limit_by_user_id(user_id)
        rift_protect = limit_dict['rift_protect']
        return rift_protect

    @staticmethod
    def get_back_fix_data(user_id):
        object_key = 'state'  # 可变参数，记得修改方法
        limit_dict, is_pass = limit_data.get_limit_by_user_id(user_id)
        state_dict = limit_dict[object_key]
        try:
